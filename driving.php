<?php
/**
Template Name: Driving Directions Subpages
 * 
 * The template used for displaying turn-by-turn driving directions, via
 * Gmap3, which is already installed by wpCasa.
 *
 * @package wpSight
 * @subpackaage CherokeeRidgeHomes
 * @since 1.0
 */
